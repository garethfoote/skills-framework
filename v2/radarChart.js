...
export function setSkillLevelsFromData(data) {
  ...
  updateRadarChart(); // refresh averages
}
...
export function overlayRadarDataset(data, label = `Imported ${overlayIndex + 1}`) {
  ...
  radarChart.data.datasets.push({
    label,
    data: scores,
    backgroundColor: overlayColors[overlayIndex % overlayColors.length].replace('0.8', '0.15'),
